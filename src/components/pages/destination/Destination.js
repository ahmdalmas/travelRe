...
import { BottomNavigation, Box, Chip, Divider, Grid, Paper, Stack, Typography, styled } from '@mui/material';
        ...
        <Row>
          <div className='destination'>
            ...
            <div className='caroussel-container'>
              <Carousel fade className='position-sticky' interval={50000} controls={false}>
                <Carousel.Item>
                ...
                <div className='booking-wrapper'>
                  <section className='booking-info'>
                    ...
                    <div className='d-flex flex-column'>
                      <div className='price-container'>
                        ...
                        <div className='d-flex justify-content-between align-items-center pt-1'>
                          <div className='d-flex'>
                            ...
                            >
                              <Micons.InfoOutlined fontSize="" onClick={handleTooltip1Open} onMouseLeave={handleTooltip1Close} className='mt-1 ms-1'></Micons.InfoOutlined>
                            </Tooltip>
                          </div>
                          <p>₹ 78 x {count}</p>
                        </div>
                        <div className='d-flex justify-content-between'>
                          <div className='d-flex'>
                            <p className='per-person'>Travl Fees</p>
                            <Tooltip
                              arrow
                              placement="right"
                              PopperProps={{
                              ...
                              title="Travl platform and service fee. You pay this only when we fulfil our on-time promise."
                            >
                              <Micons.InfoOutlined fontSize="" onClick={handleTooltip2Open} onMouseLeave={handleTooltip2Close} on={handleTooltip2Close} className='mt-1 ms-1'></Micons.InfoOutlined>
                            </Tooltip>
                          </div>
                          <div className='d-flex'>
                            <p style={{ textDecoration: count > 1 ? 'line-through' : 'none', display: count == 1 ? 'none' : 'block' }} className='px-2'>₹ {travlFee} </p>
                            {count > 1 && <Chip variant="filled" color="success" size="small" label={count > 3 ? '50% OFF' : '30% OFF'} />}
                            <p className={count > 1 && 'ps-2'}>
                              ₹ {count > 1 && count < 4 && (travlFee - travlFee * 0.3) || count > 3 && (travlFee - travlFee * 0.5) || travlFee}
                            </p>
                          </div>
                        </div>
                      ...
                      <div className='booking-button'><button type='button' className='btn-book'>Apply Now</button></div>
                    </div>
                  </section>
                </div>
              ...
              <div className='mt-5'>
                ...
                >
                  <Item className='card pt-3 justify-content-start w-50 text-dark rounded-3'>
                    <div className='d-flex '>
                      <div className='pt-2 pb-3 px-2 align-content-center'> <Micons.CalendarMonthRounded /></div>
                      <div className='align-self-start'>
                        <p className='mb-1 fw-600'>Validy Period</p>
                        <p className='m-0'>60 days</p>
                      </div>
                    </div>
                    <Divider sx={{ opacity: 1 }} className='m-3' variant="inset" />
                    <div className='d-flex mb-2'>
                      <div className='pt-2 pb-3 px-2 align-content-center'> <Micons.ExitToApp /></div>
                      <div className='align-self-start'>
                  ...
                  <Item className='w-50 p-0 rounded-3'>
                    <div className="card mb-3 h-100" style={{ maxWidth: '100%' }}>
                      <div className='d-flex card-header'>
                        <div className='align-self-center'><Micons.TextSnippet /></div>
              ...
              <BottomNavigation>
                <Row className='justify-content-between w-100'>
                  ...
                  <Col className='align-content-center justify-content-center w-100'>
                    <button className='bottom-nav-btn w-100' type="submit">Start Application</button>
                  </Col>
                </Row>
              </BottomNavigation>
            </Paper>
