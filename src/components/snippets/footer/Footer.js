...
function Footer() {
  return (
    <div className=" footer-section bottom-0 position-relative h-75">
                ...
                <div className="footer-widget">
                  <div class="footer-logo">
                    <a href="/">
                      ...
                      3Tours<i className="fab fa-gripfire fs-1"></i>
                      </div>
                      <h3>
                        Want{" "}
                        <span>
                      ...
                      <a class="primary-btn1" href="/package">
                        Book A Tour
                      </a>
                    </a>
                  </div>
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                <div class="footer-widget">
                  ...
                  <ul class="widget-list">
                    ...
                    <li>
                      <a href="/package-grid">Tour Package</a>
                    </li>
                    <li>
                      <a href="/guide2">Tour Guide</a>
                    </li>
                    <li>
                      <a href="/blog-grid">Article</a>
                    </li>
                  </ul>
                </div>
              </div>
