...
function BannerFooter() {
  return (
    ...
    //   <Container fluid>
    //     <Row className='g-lg-0 gy-5'>
    //       <Col className='col-lg-3 col-sm-6 d-flex align-items-center justify-content-lg-start justify-content-center order-lg-1 order-2'>
    ...
    //         </div>
    //       </Col>
    //       <Col className='col-lg-6 order-lg-2 order-1'>
    //         <div className='banner-content'>
    //           <h2>Join The Newsletter</h2>
    //           <p>To receive our best monthly deals</p>
    //         </div>
    //       </Col>
    //       <Col className='col-lg-3 col-sm-6 d-flex align-items-center justify-content-lg-end justify-content-center order-3'>
    ...
    //           <div className='content'>
    //             <span>Send Mail</span>
    //             <a href="mailto:3Tours@mail.com">3Tours@mail.com</a>
    //           </div>
    //         </div>
    //       </Col>
    //     </Row>
              ...
              <form>
                <div class="from-inner">
                  <input
                    ...
                    fdprocessedid="n2ayoh"
                  />
                  <button
                    type="submit"
                    class="from-arrow"
                    fdprocessedid="hnz9uo"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
